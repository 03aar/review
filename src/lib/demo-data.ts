...
export const DEMO_REVIEWS = [
  ...
  },
  {
    ...
    rawInputType: "voice",
    generatedReview: "We celebrated our anniversary at Sakura Bistro and the staff made it truly memorable. They remembered our occasion and brought out a special dessert with a congratulations note. My wife was thrilled. The matcha cheesecake was divine. This level of personal touch is rare — thank you, Sakura Bistro!",
  ...
  },
  {
    ...
    rawInputType: "text",
    generatedReview: "Sakura Bistro's lunch specials are an excellent value — generous portions at very reasonable prices. The bento box lunch is my go-to. My only suggestion would be to expand the vegetarian options. While they have a few, more variety would be welcome for plant-based diners like myself.",
    finalReview: "Sakura Bistro's lunch specials are an excellent value — generous portions at very reasonable prices. The bento box lunch is my go-to. My only suggestion would be to expand the vegetarian options. While they have a few, more variety would be welcome for plant-based diners like myself.",
    platform: "yelp",
    sentiment: "positive",
  ...
  },
  {
    ...
    rawInputType: "voice",
    generatedReview: "Sakura Bistro's happy hour is the best-kept secret in town. The prices are fantastic and the food quality doesn't dip one bit. The edamame is perfectly salted and the gyoza are crispy, juicy perfection. Pair with their yuzu highball and you've got yourself an unbeatable evening. We come here every Friday!",
  ...
  },
  {
    ...
    rawInputType: "voice",
    generatedReview: "Sakura Bistro is a fantastic family restaurant. We brought our two kids and they absolutely loved the teriyaki chicken — cleaned their plates! The staff was incredibly accommodating with the kids, bringing out crayons and paper without us even asking. Great portions, great prices, and a welcoming atmosphere for families.",
    finalReview: "Sakura Bistro is a fantastic family restaurant. We brought our two kids and they absolutely loved the teriyaki chicken — cleaned their plates! The staff was incredibly accommodating with the kids, bringing out crayons and paper without us even asking. Great portions, great prices, and a welcoming atmosphere for families.",
    platform: "google",
    sentiment: "positive",
  ...
  },
  {
    ...
    rawInputType: "text",
    generatedReview: "We hosted our company dinner in Sakura Bistro's private dining room and it was perfection. The room comfortably seats 20, the service was impeccable, and the prix fixe menu was curated beautifully. Every course was a hit with our team. The staff handled all the logistics seamlessly. Highly recommend for corporate events.",
